...
import { PrefixSchema } from "@/types/prefix.type";
...
export function CreatePrefixDialog() {
  ...
  async function onSubmit(data: z.infer<typeof PrefixSchema>) {
    try {
      setLoading(true);
      const response: DataType = await axios.post(
        `${API_URL}/admin/prefix`,
        data
      );
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>เพิ่มคำนำหน้า</DialogTitle>
          <DialogDescription>Create prefix here</DialogDescription>
        </DialogHeader>
